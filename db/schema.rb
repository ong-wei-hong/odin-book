...
ActiveRecord::Schema.define(version: 2021_10_24_110343) do
  ...
  add_foreign_key "friends", "users", column: "friend_a_id"
  add_foreign_key "friends", "users", column: "friend_b_id"
